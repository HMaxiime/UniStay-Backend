-- CreateEnum
CREATE TYPE "Role" AS ENUM ('STUDENT', 'HOST', 'EMPLOYER', 'ADMIN');
...
-- CreateEnum
CREATE TYPE "ScheduleType" AS ENUM ('FULL_TIME', 'PART_TIME', 'INTERNSHIP');
...
-- AddForeignKey
ALTER TABLE "Housing" ADD CONSTRAINT "Housing_hostId_fkey" FOREIGN KEY ("hostId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
